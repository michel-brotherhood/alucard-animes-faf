      ...
      <section className="bg-gradient-to-b from-secondary to-primary py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-white/90 text-center mb-12">
            Centro de Exposições Assis Brasil - Porto Alegre/RS
          </p>
          ...
          <div className="mt-12 bg-accent/20 backdrop-blur-sm rounded-xl p-6 border-2 border-accent">
            ...
            <p className="text-white/90 mb-4">
              <strong>Endereço:</strong> Av. Assis Brasil, 8787 - Sarandi, Porto Alegre - RS
            </p>
            <p className="text-white/90 mb-4">
              <strong>Transporte Público:</strong> Linhas de ônibus: 123, 456, 789
            </p>
            <p className="text-white/90">
              <strong>Estacionamento:</strong> Vagas disponíveis no local (sujeito a lotação)
            </p>
          </div>
        </div>
      </section>
